<template>
  <main class="min-h-[calc(100vh-4rem)]">
    ...
    <div v-else-if="store.report" class="animate-fade-up">
      ...
      <!-- Full-width container with max clamp -->
      <div class="max-w-screen-xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div class="flex flex-col lg:flex-row gap-6 items-start">
          ...
          <!-- ─── Sidebar (Sources) ─── -->
          <aside class="w-full lg:w-72 xl:w-80 shrink-0 lg:sticky lg:top-20 lg:max-h-[calc(100vh-6rem)] lg:overflow-y-auto">
    ...
    <div
      v-else
      class="flex flex-col items-center justify-center min-h-[80vh] text-center px-6 animate-fade-up"
    >
      <div class="w-20 h-20 rounded-3xl glass-amber flex items-center justify-center text-4xl mb-6">
        🔬
      </div>
      <h2 class="text-2xl font-semibold mb-2" style="font-family:'Fraunces',serif">
        No report yet
      </h2>
